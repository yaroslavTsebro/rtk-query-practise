...
import { useUpdatePostMutation, useDeletePostMutation, useGetPostsQuery } from "../../../app/service/posts"
...
const EditPostForm = () => {
  ...
  const { data: posts, isLoading: isLoadingPosts, isSuccess } = useGetPostsQuery()
